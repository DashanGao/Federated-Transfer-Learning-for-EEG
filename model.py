...
class SPDNetwork_2(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.w_1_p = Variable(torch.randn(32, 16).double(), requires_grad=True)
        self.w_2_p = Variable(torch.randn(16, 8).double(), requires_grad=True)
        self.w_3_p = Variable(torch.randn(8, 4).double(), requires_grad=True)
        self.fc_w = Variable(torch.randn(16, 2).double(), requires_grad=True)
