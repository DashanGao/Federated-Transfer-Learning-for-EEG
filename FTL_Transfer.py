...
def transfer_SPD(cov_data_1, cov_data_2, labels_1, labels_2):
	...
	for iteration in range(200):
		...
		print('Iteration {}: Trainning Accuracy for Model 1: {:.4f} / Model 2: {:.4f}'.format(iteration, correct_1.item()/pred_1.shape[0], correct_2.item()/pred_2.shape[0]))
...
if __name__ == '__main__':
	...
	#Good Subject
	cov_data_1 = np.concatenate(data[[0, 1, 6, 7, 14, 28, 30, 32, 33, 34, 41, 47, 51, 53, 54, 55, 59, 61, 69, 70, 71, 72, 79, 84, 85, 92, 99, 103]],axis=0)
	labels_1 = np.concatenate(label[[0, 1, 6, 7, 14, 28, 30, 32, 33, 34, 41, 47, 51, 53, 54, 55, 59, 61, 69, 70, 71, 72, 79, 84, 85, 92, 99, 103]], axis=0)
